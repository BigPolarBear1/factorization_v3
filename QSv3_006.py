...
###WORK IN PROGRESS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
###Factorization_v3_minor_version_006
...
def find_comb(lists,n,procnum,return_dict,rstart,rstop,primeslist1,hmap,fast_ind_map):
    ...
    while alpha < rstop:
        ...
        iN2=1
        ######Now that everything is simplified... all that is left to do is get rid of this loop! last thing before victory.
        while iN2 < 1000:  
            rel_iN=(iN-iN2)%mod
            i=0
            bad =0
