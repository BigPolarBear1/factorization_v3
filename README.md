...
ps: I just saw the msft downgraded the severity of atleast one of my bugs retroactively. They are now saying my IKE rce bug, which was multiple bugs bundles together, one of which was a stack buffer overrun with control over size and contents which could be triggered remotely pre-auth. Fucking amateurs. So mad that I was better then all of them together. 0 skills. Don't ever cross my path. This is warning. I will end you people.
