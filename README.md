...
You know, much more then working at the algorithmic level, I really want to go back to the granular number theoretical level. There is still so much to figure out. There is something here, I can nearly see it, reach for it... I just need a normal life again, be able to actually focus. That's the worst part about being broke, isolated and depressed.. it makes it impossible to focus. I guess with some luck, I will still have 30 years in my career to be productive... that's 30 years to figure this out... figure out this thing about divisibility and composites... the structure of it... that whole square finding trick, its just the top of the iceberg... there are some much deeper generalizations that come from that.. and I really need to figure it out for some reason. Like, even if I set a factoring record.. I can't stop until I figure this thing out. I wish I had some money though, so I could live with some dignity. Cant even find an 0day buyer lol... that would have been an easy way to make money... software bugs are easy compared to what I'm doing now.
