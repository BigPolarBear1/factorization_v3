UPdate FINAL3: Actually I might just edit YAFU as that seems a bit more modern then msieve and the code is also easier to look at. If I get a significant speed increase.. then that proves my work. It's not what I want to do. I will do what I really want to do in v4... but for my own sanity, I need atleast a breakthrough, no matter how small.. and hopefully stop the unemployment. Give me a +/- a week... Shouldn't need much more then that. I'm very depressed. I really don't feel welcome in this world anymore. Banished to  be hidden away at my parent's house unable to get a job. I feel I have awoken in a dystopian world I don't recognize anymore. Big tech has truely become absolutely disgusting. And all the people involved in it are disgusting. Suddenly have a lot of respect for people hacking big comapnies and gov agencies.. we have truely shifted in a timeline where that is a just thing to do. We need a true cyberpunk (cipherpunk?) revival.. reclaim technology.. because we have the brains and tech bros and dictators don't have brains (well known fact). I'm really depressed... the world has really changed, and it doesn't suprise that everything happened that happened in 2023... the world has become deeply unsettling. Many decades from now, I am sure some science paper will attribute everything to covid and online brainwashing causing some type of social collapse and madness. There's a really unsetlling cascade happening... I fear for what is to come because it is only going to get worse now. We have crossed an invisble threshold we won't come back from easily.

UPDATE FINAL2: Thinking some more about it... I will just try to minimally edit the existing msieve source and switch over their polynomials to mine and use the linear coefficient instead of what they are doing. If I'm right, that should provide a performance increase... not matter how small. And I can have something I can go show to people and make noise about. Maybe even create some career oppurtunities again. But I am not happy with small improvements.. hence in factorization_v4 I will resume what I was doing earlier and just really get to the core. Now that I've learned much of what's in the public domain, I also know my representation is rather unique... and something is really nagging me when I was representing coefficient pairings for each quadratic coefficient in a hashmap a month ago (not just 0 solutions like it is doing here to find smooth divisors)... because that hashmap contained all the information I needed to completely byspass smooth finding and just grab coefficient pairings whose square are congruent mod N.. just have this nagging feeling I gave up too early there. 
