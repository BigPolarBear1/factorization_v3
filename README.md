...
Update: Did some more benchmarking of the code tonight. Once I rework a couple of things it should be faster then the non-simd version.... quite a bit faster. I'll upload that faster version after I get some sleep. 
