...
ps: Also by indexing using that relative i-value, its very easy to create some type of sieve interval to locate good coefficient pairings. I don't know why I didn't think of this earlier, even with my previous work in the paper, it wouldn't have been hard to transform that into something that can be indexed by that relative i-value. 
