...
Update: Okay, I think I got it... hmm. It's not terribly complicated to use roots in a finite field instead. Then in a^2 = b^2 mod N, we instead get (a + x * finite field modulus)^2 = b^2 mod N. And hopefully we can set it up such that x is usually a small value that is quick to find. The main advantage being that atleast it eliminates the smooth finding problem. My head hurts. I should go for a run.

Update: So finding that x, its a hard problem. Buuuuuut.... I noticed something. There is a way to actually immediatly calculate that x, atleast in some cases. I'll have to do the math to try and generalize it to other cases too.
If your squared coefficient is in one finite field, and you find the other side of the congruence so that it is a  square in a different finite field (using jacobi/legendre symbols)..  there is a way to find that x very quickly if certain conditions are met. I see it now. PoC incoming soon if all goes well...

Update: Eureka!! Messed around for a couple more hours... and now I got it I believe :)))))!!!!!!!!!! I pray this is coincidence.. I'll try and sleep for now.. if this is true.. then tomorrow is going to be a high-stress day. I don't know.. what are the odds I stumbled on something everyone else missed... tomorrow we'll see. Just bc it worked with one integer doesn't mean anything yet.. I'll need to run more samples to be sure.  I'm still willing to sell my work.. but once its done and I don't have a buyer... its going online... because there is no way I can hold on to in this place.. that would just endanger everyone around me honestly. But anyway.. still got to see tomorrow if this math adds up I guess.

God damnit, this is stressful. On the off-chance, that this is it... that this is going to hold for all integers.. I don't know... I will just assume that since no buyers have appraoched me yet, nobody is really interested in what I'm doing, and hence, nobody is going to drone strike me or some shit... incase tomorrow, it ends up working.. I pray for the safety of all around me. 
