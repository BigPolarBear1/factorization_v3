...
Since these quadratic coefficients dictate how many times N the quadratic should produce... we can easily verify if a given linear coefficient is at the correct quadratic coefficient.
