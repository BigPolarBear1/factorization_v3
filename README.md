...
So we need to maximize the modulus of two selections at different i values, while minimizing the i value (and the bigger that difference between i value and modulus, the more likely we have a square relation).
